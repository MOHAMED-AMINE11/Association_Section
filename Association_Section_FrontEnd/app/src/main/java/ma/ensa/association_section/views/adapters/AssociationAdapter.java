package ma.ensa.association_section.views.adapters;
...
// views/adapters/AssociationAdapter.java
public class AssociationAdapter extends RecyclerView.Adapter<AssociationAdapter.AssociationViewHolder> {
    ...
    public AssociationAdapter(OnAssociationClickListener listener) {
    ...
    class AssociationViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Association association) {
            ...
            tvContact.setText(String.format("%s - %s",
                    association.getTelephone(), association.getEmail()));
        }
    }
}
